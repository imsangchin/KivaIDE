...
import com.kiva.ide.util.PixelDipConverter;
...
public class MaterialRippleLayout extends FrameLayout {
    ...
    public MaterialRippleLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        rippleDiameterPx = a.getDimensionPixelSize(R.styleable.MaterialRippleLayout_mrlRippleDiameter,
                (int) PixelDipConverter.convertDpToPixel(DEFAULT_DIAMETER_DP, getContext()));
    ...
    public static class RippleBuilder {
        ...
        public MaterialRippleLayout create() {
            ...
            layout.setRippleDiameterPx((int) PixelDipConverter.convertDpToPixel(rippleDiameterDp,context));
            ...
            layout.setRippleRoundedCornersPx((int) PixelDipConverter.convertDpToPixel(rippleRoundedCornerDp,context));
