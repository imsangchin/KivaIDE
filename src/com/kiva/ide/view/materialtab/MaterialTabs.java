package com.kiva.ide.view.materialtab;
...
public class MaterialTabs extends HorizontalScrollView {
    ...
    private OnTabItemLongClickListener mOnTabItemLongClickListener;
    ...
    private void addTab(final int position, CharSequence title, View tabView) {
        ...
        tabView.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View arg0) {
				...
				if (mOnTabItemLongClickListener != null) {
					return mOnTabItemLongClickListener.onTabItemLongClick(position);
				}
...
//                        tab_title.setAllCaps(true);
                    	tab_title.setAllCaps(false); // Kiva: no toUpperCase()
                    } else {
    ...
    public void setOnTabItemLongClickListener(
			OnTabItemLongClickListener mOnTabItemLongClickListener) {
		this.mOnTabItemLongClickListener = mOnTabItemLongClickListener;
	}
    
    public static interface OnTabItemLongClickListener {
    	boolean onTabItemLongClick(int position);
    }
